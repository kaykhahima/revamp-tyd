                                        ...
                                        <div class="col-md-3">
                                            <div class="card rounded text-dark mb-2">
                                                <div class="card-body p-3">
                                                    ...
                                                    <a class="text-center btn btn-danger btn-sm btn-block mt-2" href="<?php echo BASE_URL;?>/services/courses/web-development-with-laravel" role="button">View Course</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card rounded text-dark mb-2">
                                                <div class="card-body p-3">
                                                    ...
                                                    <h5 class="text-dark mb-1">Tzs 399,000/=</h5>
                                                    <p class="small mb-1"><i class=" fa fa-calendar"></i> 4 Weeks</p>
                                                    <a class="text-center btn btn-danger btn-sm btn-block mt-2" href="#" role="button">View Course</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
